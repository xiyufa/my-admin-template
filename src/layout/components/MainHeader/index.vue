<template>
  <div class="main-header-wrap" :class="{ collapse: isCollapse }">
    <!-- 折叠按钮 -->
    <fold-button :isCollapse="isCollapse" @toggle-click="toggleCollapse" v-if="showCollapse"></fold-button>
    ...
    <!-- 选择语言 -->
    <select-language class="select-lang" v-if="showlanguage"></select-language>

    <!-- 选择大小  -->
    <select-size class="select-size" v-if="showSize"></select-size>
...
export default {
  ...
  computed: {
    ...mapGetters(['isCollapse', 'userInfo', 'showCollapse', 'showlanguage', 'showSize'])
  },
  data() {
    return {}
  },
